\documentclass[journal,8pt,onecolumn]{IEEEtran}
\usepackage{graphicx}
...
\begin{lstlisting}
codes/RV/cdf_uniform.py
\end{lstlisting}
\begin{figure}[H]
\centering
\includegraphics[width=\columnwidth/2]{./figs/uni_cdf.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=\columnwidth/2]{./figs/tri_pdf.pdf}
...
\solution From the plots \figref{fig:tri_cdf} and \figref{fig:tri_pdf}, it is evident that numerical and theoretical values are similar.
\end{enumerate}
...
import numpy as np	
samples = 500
X = np.random.binomial(1, 0.5, samples)
\end{lstlisting}
\item Generate 
\begin{equation}
Y = AX+N,
...
\begin{lstlisting}
codes/MLE/scatter.py
\end{lstlisting}
\begin{figure}[H]
\centering
\includegraphics[width=\columnwidth/2]{./figs/bpsk_scatter.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=\columnwidth/2]{./figs/bpsk_const.eps}
\caption{}
...
%\iffalse
\begin{lstlisting}
codes/exercise/bpsk.py
\end{lstlisting}
%	\fi
yields \figref{fig:bpsk_ber}
\begin{figure}[H]
\centering
\includegraphics[width=\columnwidth/2]{./figs/bpsk_ber.pdf}
\caption{}
\label{fig:bpsk_ber}
\end{figure}
